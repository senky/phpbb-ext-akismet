...
$lang = array_merge($lang, array(
	...
	'ACP_AKISMET_INTRO'					=> 'Esta extensión usará el servicio <a href="http://akismet.com">Automático de Akismet</a> para proteger su foro de correo no deseado, colocando nuevos mensajes sospechosos directamente en la cola de moderación de forma automática.',
	...
	'ACP_AKISMET_SIGN_UP'				=> 'Para usar esta extensión, primero debe <a href="http://akismet.com">registrarse para obtener una clave API</a>, luego deberá ingresar dicha clave a continuación.',
	'ACP_AKISMET_UNENCRYPTED_WARNING'	=> 'Tenga en cuenta que los nuevos temas y mensajes se pasarán sin cifrar, es decir, a través de una conexión HTTP estándar, a los servidores Akismet para su verificación.',
	...
	'ACP_AKISMET_CHECK_REGISTRATIONS_EXPLAIN'	=> 'Si elige “si”, Akismet intentará detectar probables spammers tan pronto como se registren, antes de que hayan publicado respuestas o nuevos temas.',
	...
	'ACP_AKISMET_ADD_DETECTED_BLATANT_SPAMMERS_TO_GROUP_EXPLAIN'	=> 'La detección de Akismet “evidente” de spammers se desencadenará por el peor, más penetrante y obvio spam. Puede agregar estos spammers a un grupo en particular, también, sin privilegios de publicación. <strong>Nota: Por razones de seguridad, solo puede agregar nuevos registros de spam a grupos definidos por el usuario o al grupo Nuevos usuarios registrados</strong>.',
